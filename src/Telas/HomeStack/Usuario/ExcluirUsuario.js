...
import { buscarUsuario, excluirUsuario } from "../../../utils/Usuario/usuarioController";
import { ModalUsuario } from "../../../Components/Modais";


export function ExcluirUsuario({route}) {
    ...
    if(modalVisible){
      return (
        ...
        status={status}
        tipo={tipo}
        labelActionBtn="Excluir Usuário"
        action={() => {excluirUsuario({id}).then((response)=>{
